Ext.define('ExtjsBox.view.douban.movie.MovieIndex', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.ExtjsBox.view.douban.movie.MovieIndex',
	requires: [
		...
		return [
			{
                ...
                xtype: 'ExtjsBox.view.douban.movie.MovieGrid',
                name : 'movieGrid',
                itemId : 'movieGrid'
            }
		];
